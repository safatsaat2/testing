...
function firstSrsTheme_demo_shortcode($atts, $content = null) {
    $atts = shortcode_atts(array(
        "title" => "default",
        "id" => null
    ), $atts);
    
return "<div class='display-1'>" . esc_html($atts["title"]) . " id=". esc_html($atts["id"])."</div>";
};

add_shortcode("demo_shortcode", "firstSrsTheme_demo_shortcode");
